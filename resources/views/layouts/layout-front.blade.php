...
<head>
    ...
    <title>Probe Bangladesh Official</title>
                    ...
                    <div class="header-column justify-content-start w-50 order-md-1 d-md-flex">
                        <div class="header-row">
                            <div class="header-logo">
                                <a href="{{URL::to('/')}}">
                                    <img alt="Probe" src="public/frontend/img/prob.png" class="img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="header-nav-main header-nav-main-square header-nav-main-effect-1 header-nav-main-sub-effect-1">
                                            <nav class="collapse">
                                                <ul class="nav nav-pills flex-column flex-lg-row" id="mainNav">
                                                    <li class="dropdown"><a class="dropdown-item dropdown-toggle active" href=""> ABOUT US </a>
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="">Company</a></li>
                                                            <li class="dropdown-submenu"><a href="">Management</a></li>
                                                            <li class="dropdown-submenu"><a href="">Milestone</a></li>
                                                            <li class="dropdown-submenu"><a href="">Investor</a></li>
                                                            <li class="dropdown-submenu"><a href="">CSR</a></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li class="dropdown">
                                                        <a class="dropdown-item dropdown-toggle" href="{{url('franchise')}}"> FRANCHISE</a>
                                                    </li>
            ...
            <div class="row py-4 my-4 footer_bottom">
                ...
                <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="media imp-links pb-1"><a href="{{url('/')}}">Home</a></li>
                        <li class="media imp-links pb-1"><a href="{{url('/')}}">Partners</a></li>
                        <li class="media imp-links pb-1"><a href="{{url('/')}}">Franchise</a></li>
                        <li class="media imp-links pb-1"><a href="{{url('/')}}">Contact</a></li>
                    </ul>
                </div>
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3 pb-1">
                                <p class="text-3 text-color-light opacity-8 mb-1 footer_contact">
                                    <strong>House No.9,Road No.1 Block-F,
                                        Janata Co-operative,Houseing Society Ltd,
                                        Ring Road Adabar,Dhaka-1207,Bangladesh.
                                    </strong>
                                </p>
                                <h6 class="footer_contact">For Patient</h6>
                                <p class="footer_contact">Mobile:+8801942559895 <br>Email:contact.alok@gmail.com</p>
                                <h6 class="footer_contact">For Partner</h6>
                                <p class="footer_contact">Mobile:+8801875314620<br>Email:contact.alok@gmail.com</p>
                ...
                <div class="col-md-6 col-lg-2">
                    ...
                    <p class="social-links">
                        <a href="https://www.facebook.com/PROBEBD/" target="__blank"><span
                                    class="py-2 mr-1 mb-2"><span
                                        class="fa fa-facebook-square"></span> FACEBOOK</span></a>
                        <br><a href="#">
                            <span class="py-2 mr-1 mb-2"><span class="fa fa-twitter-square"></span> TWITTER</span>
                        </a>
                        <br><a href="#">
                            <span class="py-2 mr-1 mb-2"><span class="fa fa-youtube-square"></span> YOUTUBE</span>
                        </a>
                        <br><a href="#">
                            <span class="py-2 mr-1 mb-2"><span class="fa fa-linkedin-square"></span> LINKED IN</span>
                        </a>
                        <br><a href="#">
                            <span class="py-2 mr-1 mb-2"><span class="fa fa-whatsapp"></span> WHATSAPP</span>
                        </a>
                    </p>
                </div>
            </div>
                ...
                <div class="row py-4">
                    <div class="col-lg-2 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
                        <a href="#" class="logo pr-0 pr-lg-3">
                            <img alt="Porbe Bangladesh Official" src="public/frontend/img/prob.png" class="opacity-5" height="33">
                        </a>
                    </div>
