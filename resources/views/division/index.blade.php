...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{URL::to('division')}}">Division</a></li>
        </ol>
    </section>
    <!-- Main content -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-inline">
                                        ...
                                        <div class="input-group">
                                            {{Form::open(array('route'=>['division.destroy',$data->id],'method'=>'DELETE'))}}
                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title"><i class="fa fa-edit" style="color:#E08E0B"></i>Update Division</h4>
                                                </div>
                                                {!! Form::open(array('route' => ['division.update', $data->id],'class'=>'form-horizontal','method'=>'PUT')) !!}
