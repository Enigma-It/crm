...
?>
  ...
  @if( !empty($singlePurchaseData) )
        {{Form::open(array('route'=>['diagnostic-test-report-status.update',$singlePurchaseData->id],'method'=>'PUT','files'=>true))}}
        <?php 
        ...
        ?>
  @else
        {{Form::open(array('route'=>['diagnostic-test-report-status.store'],'method'=>'POST','files'=>true))}}
   @endif
            ...
            success: function(data){
              ...
              {   
                  ...
                  $.each(data.patientList, function (index, value) {
                        ...
                        console.log(value.progress_status);
                        ...
                        html += "<td><input type='hidden' name='patient_test_id["+value.id+"]' /><select name='patient_test_id["+value.id+"][progress_status]' class='form-control'>";
