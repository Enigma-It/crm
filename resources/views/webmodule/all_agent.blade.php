                                            ...
                                            @foreach($agent as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ URL::to('delete_agent/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                                                        <a href="{{ URL::to('view_agent/'.$row->id) }}" class="btn btn-sm btn-primary">View</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
...
<head>
    ...
    <title>Welcome To Probe Bangladesh</title>
    <!-- Favicon-->
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">PROBE BANGLADESH LIMITED</a>
        </div>
...
{{--                <li>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2019 - 2019 <a href="javascript:void(0);">Prolay</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.0
            </div>
